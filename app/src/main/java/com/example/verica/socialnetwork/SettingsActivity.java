...

{
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data)
    {
        ...
        if(requestCode==CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE)
        {
            ...
            {
                Toast.makeText(this,"Error ocured: Image can't be crooped. Try again.",Toast.LENGTH_SHORT).show();
                loadingBar.dismiss();
            }
        }
    }
    ...
    private void ValidateAccountInfo()
    {
        ...
        {
            Toast.makeText(this,"Please write your profile name...", Toast.LENGTH_LONG).show();
        }
        ...
        {
            Toast.makeText(this,"Please write your Data of Birth...", Toast.LENGTH_LONG).show();
        }
        ...
        {
            Toast.makeText(this,"Please write your relationship status...", Toast.LENGTH_LONG).show();
        }
        else
            {
                loadingBar.setTitle("Profile Info");
        ...
        SettingsUserRef.updateChildren(userMap).addOnCompleteListener(new OnCompleteListener() {
            ...
            public void onComplete(@NonNull Task task)
            {
             if(task.isSuccessful())
             {
                 ...
                 {
                     Toast.makeText(SettingsActivity.this,"Error occured, while updating your account",Toast.LENGTH_SHORT).show();
                     loadingBar.dismiss();
                 }

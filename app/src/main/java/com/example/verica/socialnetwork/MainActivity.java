...
public class MainActivity extends AppCompatActivity {
        ...
        UsersRef.child(currentUserID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.getValue() != null) {
                    ...
                    if (model != null) {
                        SharedPrefs.setFullName(model.getFullname());
                    }
                }
            }
    ...
    private void sendFcmKeyToserver() {
        UsersRef.child(currentUserID).child("fcmKey").setValue(SharedPrefs.getFcmKey());
    }
    ...
    private void likePost(final String postKey) {
        PostsRef.child(postKey).child("uid").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.getValue() != null) {
                    String userId = dataSnapshot.getValue(String.class);
                    if (!userId.equalsIgnoreCase(currentUserID)) {
                        getUserObjectFromDb(userId, " liked",postKey);
                    }
                }
            }
    ...
    private void getUserObjectFromDb(String userId, final String message, final String postId) {
        UsersRef.child(userId).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.getValue() != null) {
                    UserModel model = dataSnapshot.getValue(UserModel.class);
                    if (model != null) {
                        NotificationAsync notificationAsync = new NotificationAsync(MainActivity.this);
                        String NotificationTitle = SharedPrefs.getFullName() + message + " your post";
                        String NotificationMessage = "";
                        notificationAsync.execute("ali", model.getFcmKey(),
                                NotificationTitle, NotificationMessage, "Like",postId , SharedPrefs.getFullName() + " ");
    ...
    private void unlikePost(final String postKey) {
        PostsRef.child(postKey).child("uid").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.getValue() != null) {
                    ...
                    if (!userId.equalsIgnoreCase(currentUserID)) {
                        ...
                        getUserObjectFromDb(userId, " unliked",postKey);
                    }
                }
            }
